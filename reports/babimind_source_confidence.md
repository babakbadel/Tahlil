...
| ONS UK | ok | 0.600 | C | no |
| Bank of Japan | ok | 0.600 | C | no |
| Japan Statistics Bureau | ok | 0.600 | C | no |
...
| Wilson Center | ok | 0.600 | C | no |
| ECFR | ok | 0.600 | C | no |
| Peterson Institute | ok | 0.600 | C | no |
| Stimson Center | ok | 0.600 | C | no |
| Middle East Institute | ok | 0.600 | C | no |
...
| NATO | ok | 0.600 | C | no |
| OPCW | ok | 0.600 | C | no |
| Associated Press | ok | 0.600 | C | no |
| AFP | ok | 0.600 | C | no |
| BBC | ok | 0.600 | C | no |
...
| Foreign Policy | ok | 0.600 | C | no |
| War on the Rocks | ok | 0.600 | C | no |
| Council on Foreign Relations | ok | 0.600 | C | no |
| Carnegie Endowment | ok | 0.600 | C | no |
| Chatham House | ok | 0.600 | C | no |
| CSIS | ok | 0.600 | C | no |
| RUSI | ok | 0.600 | C | no |
| Iran Economist | ok | 0.600 | C | no |
| CNN | ok | 0.600 | C | no |
| France 24 | ok | 0.600 | C | no |
| DW | ok | 0.600 | C | no |
| CNBC | ok | 0.600 | C | no |
| Forbes | ok | 0.600 | C | no |
| Business Insider | ok | 0.600 | C | no |
| Fortune | ok | 0.600 | C | no |
| New York Times | ok | 0.600 | C | no |
...
| Central Bank of Iran | ok | 0.540 | C | no |
...
| Swiss National Bank | ok | 0.540 | C | no |
| SAMA | ok | 0.540 | C | no |
| Central Bank of Russia | ok | 0.540 | C | no |
| EEX | ok | 0.540 | C | no |
| ACER | ok | 0.540 | C | no |
| Atlantic Council | ok | 0.540 | C | no |
| IRNA | ok | 0.540 | C | no |
| ISNA | ok | 0.540 | C | no |
...
| The Telegraph | ok | 0.540 | C | no |
| Der Spiegel | ok | 0.540 | C | no |
| Die Zeit | ok | 0.540 | C | no |
| El Pais | ok | 0.540 | C | no |
| TASS | ok | 0.540 | C | no |
...
| La Nacion Argentina | ok | 0.540 | C | no |
...
| TSETMC Index | unavailable | 0.113 | D | no |
| TSETMC Funds | unavailable | 0.113 | D | no |
| TSETMC Client Type | unavailable | 0.113 | D | no |
| TSETMC Market Overview | unavailable | 0.113 | D | no |
| TSETMC Codal Publisher | unavailable | 0.113 | D | no |
| TSETMC Messages | unavailable | 0.113 | D | no |
| TSETMC Shareholders | unavailable | 0.113 | D | no |
| TSETMC Trade Top | unavailable | 0.113 | D | no |
| TSETMC Price History | unavailable | 0.113 | D | no |
| Codal | unavailable | 0.113 | D | no |
| Statistical Center of Iran | unavailable | 0.113 | D | no |
...
| CME Group | unavailable | 0.113 | D | no |
| Nasdaq | unavailable | 0.113 | D | no |
| Tehran Stock Exchange | unavailable | 0.113 | D | no |
| Iran Fara Bourse | unavailable | 0.113 | D | no |
| National Iranian Gas Company | unavailable | 0.113 | D | no |
| Ministry of Energy Iran | unavailable | 0.113 | D | no |
| Iran Tax Administration | unavailable | 0.113 | D | no |
| Iran Ports and Maritime Organization | unavailable | 0.113 | D | no |
| Sena | unavailable | 0.113 | D | no |
| Turkish Statistical Institute | unavailable | 0.113 | D | no |
| COMEX | unavailable | 0.113 | D | no |
| NYMEX | unavailable | 0.113 | D | no |
| Shabestan | unavailable | 0.113 | D | no |
| Alef | unavailable | 0.113 | D | no |
| Washington Post | unavailable | 0.113 | D | no |
| Xinhua | unavailable | 0.113 | D | no |
| IMF SDMX Central | error | 0.060 | D | no |
| OECD Data | error | 0.060 | D | no |
| IEA Data | error | 0.060 | D | no |
| OPEC | error | 0.060 | D | no |
| ILOStat | error | 0.060 | D | no |
| Reuters | error | 0.060 | D | no |
| IMF Iran | error | 0.060 | D | no |
| UNDP Data | error | 0.060 | D | no |
...
| UN Security Council | error | 0.060 | D | no |
| US State Department | error | 0.060 | D | no |
| IAEA | error | 0.060 | D | no |
| Reuters Markets | error | 0.060 | D | no |
| Bloomberg Markets | error | 0.060 | D | no |
| Arab News | error | 0.060 | D | no |
| Al Arabiya | error | 0.060 | D | no |
| Mining.com | error | 0.060 | D | no |
| CoinDesk | error | 0.060 | D | no |
| International Crisis Group | error | 0.060 | D | no |
| Sky News | error | 0.060 | D | no |
| Bloomberg | error | 0.060 | D | no |
| Financial Times | error | 0.060 | D | no |
| Wall Street Journal | error | 0.060 | D | no |
| MarketWatch | error | 0.060 | D | no |
| Barron's | error | 0.060 | D | no |
| The Economist | error | 0.060 | D | no |
| Politico | error | 0.060 | D | no |
| Axios | error | 0.060 | D | no |
...
| UN Comtrade | error | 0.054 | D | no |
| S&P Global | error | 0.054 | D | no |
...
- **monetary** → primary: `Federal Reserve`; fallback: Bank of England, Bank of Japan, Deutsche Bundesbank
...
- **events** → primary: `Associated Press`; fallback: AFP, BBC, France 24
...
- **iran_macro** → primary: `World Bank Iran`; fallback: CEIC Iran, Central Bank of Iran, Iran Open Data
...
- **iran_industry** → primary: `Ministry of Industry Mine Trade`; fallback: -
- **development** → primary: `UNDP Data`; fallback: -
- **metals** → primary: `World Platinum Investment Council`; fallback: COMEX, LME, Mining.com
- **futures** → primary: `ICE Markets`; fallback: CME Group
- **global_equity** → primary: `MSCI`; fallback: NYSE, Nasdaq
- **market** → primary: `Investing Iran Markets`; fallback: -
...
- **iran_business** → primary: `Iran Chamber of Commerce`; fallback: -
- **rates_policy** → primary: `US Treasury`; fallback: -
- **credit** → primary: `Moody's`; fallback: Fitch Ratings
- **volatility** → primary: `Cboe`; fallback: -
...
- **geopolitics** → primary: `IISS`; fallback: Wilson Center, Stimson Center, Foreign Affairs
...
- **global_economy** → primary: `Peterson Institute`; fallback: -
- **middle_east** → primary: `Middle East Institute`; fallback: Washington Institute, Al Jazeera, The National
...
- **news_events** → primary: `Iran Economist`; fallback: CNN, France 24, DW
