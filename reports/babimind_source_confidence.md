...
| EEX | ok | 0.540 | C | no |
| ACER | ok | 0.540 | C | no |
| Morningstar | ok | 0.540 | C | no |
| UK FCDO | ok | 0.540 | C | no |
| AFP | ok | 0.540 | C | no |
...
- **events** → primary: `Associated Press`; fallback: BBC, France 24, DW
...
- **news_events** → primary: `IRNA`; fallback: ISNA, PANA, SNN
