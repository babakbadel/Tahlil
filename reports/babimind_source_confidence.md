...
| Donya-e-Eqtesad | unavailable | 0.113 | D | no |
| Bourse24 | unavailable | 0.113 | D | no |
...
| New York Times | error | 0.060 | D | no |
...
| Indian Express | error | 0.054 | D | no |
...
- **news_events** → primary: `IRNA`; fallback: ISNA, Iran Economist, CNN
