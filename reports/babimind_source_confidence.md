...
| NATO | ok | 0.540 | C | no |
| Associated Press | ok | 0.540 | C | no |
| Nikkei Asia | ok | 0.540 | C | no |
| Rigzone | ok | 0.540 | C | no |
...
| UN Security Council | error | 0.054 | D | no |
...
- **macro** → primary: `IMF Data API`; fallback: World Bank API, FRED, Trading Economics
- **monetary** → primary: `Federal Reserve`; fallback: Bank of England, Bank of Japan, Banque de France
...
- **news_events** → primary: `IRNA`; fallback: ISNA, Tejarat News, CNN
