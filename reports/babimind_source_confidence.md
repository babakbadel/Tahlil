...
| TSETMC Shareholders | error | 0.054 | D | no |
| PBOC | error | 0.054 | D | no |
| TSETMC Messages | error | 0.045 | D | no |
| TSETMC Trade Top | error | 0.045 | D | no |
...
- **news_events** → primary: `Eghtesad Online`; fallback: CNN, France 24, DW
