...
| UN Security Council | ok | 0.450 | D | no |
| US Treasury OFAC | ok | 0.450 | D | no |
| Raja News | ok | 0.450 | D | no |
...
| ACER | unavailable | 0.113 | D | no |
| IMNA | unavailable | 0.113 | D | no |
| Shabestan | unavailable | 0.113 | D | no |
| Sedaye Bourse | unavailable | 0.113 | D | no |
...
| Stimson Center | error | 0.060 | D | no |
...
| UAE Central Bank | error | 0.054 | D | no |
...
- **iran_macro** → primary: `World Bank Iran`; fallback: Central Bank of Iran, Iran Open Data, CEIC Iran
- **iran_commodities** → primary: `Iran Mercantile Exchange`; fallback: -
- **iran_energy** → primary: `Ministry of Petroleum`; fallback: Iran Energy Exchange, SHANA, Iran Power Grid Management
