...
| La Tribune | ok | 0.450 | D | no |
| China Daily | ok | 0.450 | D | no |
...
- **events** → primary: `AFP`; fallback: BBC, DW, TSETMC Messages
...
- **news_events** → primary: `IRNA`; fallback: ISNA, Mehr News, Eghtesad Online
